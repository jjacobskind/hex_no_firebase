...
describe('Game class', function() {
	...
	it('returns the length of the longest road on the board', function(){
		...
		i++;
		game.board.constructRoad(game.players[0],[1,1], 'left');
		i++;


		game.board.placeSettlement(game.players[1],[1,1]);


		game.board.constructRoad(game.players[0],[0,0], 'left');
		i++;
		game.board.constructRoad(game.players[0],[1,0], 'vertical');
		i++;

		game.board.constructRoad(game.players[0],[3,0], 'vertical');
