// Generated on 2014-11-24 using generator-angular-fullstack 2.0.13
'use strict';
    ...
    watch: {
      injectJS: {
        files: [
          ...
          '!<%= yeoman.client %>/{app,components}/game-engine/index.js',
        ...
        files: {
          '<%= yeoman.client %>/index.html': [
              ['{.tmp,<%= yeoman.client %>}/{app,components}/**/three.min.js',
               '{.tmp,<%= yeoman.client %>}/{app,components}/game-engine/index.js',
               '{.tmp,<%= yeoman.client %>}/{app,components}/**/*.js',
